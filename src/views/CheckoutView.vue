<template>
  <div class="checkout-page page-layout-margin">
    ...
    <div class="checkout-page__heading">
      <p class="heading-5">
        <span class="dark-gray-text">Returning Customer?</span>
        <router-link
          :to="{ name: 'auth' }"
          class="navigation__link navigation__link--dark"
          >Click here to login</router-link
        >
      </p>
      <p class="heading-5">
        <span class="dark-gray-text">Have a coupon?</span>
        <base-button @click.native="toggleShowApplyCouponContainer">Click here to enter your code</base-button>
      </p>

      <div
        v-if="showApplyCouponContainer"
        class="checkout-page__coupon"
      >
        <p class="heading-5 dark-gray-text checkout-page__coupon-title">
