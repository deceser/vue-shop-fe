<template>
  <div class="privacy-policy page-layout-margin">
    <div class="privacy-policy__group">
      <h1 class="heading-1 text-capitalize page__title">shipping and returns</h1>
    </div>
    <div class="privacy-policy__group">
      <p class="heading-5">
    ...
    <div class="privacy-policy__group">
      <h4 class="privacy-policy__group--header">Security</h4>
      <p class="heading-5">
        Duis rutrum dictum libero quis rutrum. Etiam sed neque aliquam, sollicitudin ante a, gravida arcu. Nam fringilla
        molestie velit, eget pellentesque risus scelerisque.
      </p>
    </div>
    <div class="privacy-policy__group cookies">
      <h4 class="privacy-policy__group--header">Cookies</h4>
      <p class="heading-5 cookies__item">
        ● Duis rutrum dictum libero quis rutrum. Etiam sed neque aliquam, sollicitudin.
      </p>
      <p class="heading-5 cookies__item">● Nam fringilla molestie velit, eget pellentesque risus scelerisque a</p>
    </div>
  </div>
</template>
...
<style lang="scss">
  ...
  .privacy-policy {
    ...
    &__group {
      ...
      &--header {
        @include typeface(400, 1.8rem, 2.7rem);
